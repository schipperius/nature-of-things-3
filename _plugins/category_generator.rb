...
# the category_feed.xml file to the _includes directory of your own project
# (https://github.com/recurser/jekyll-plugins/blob/master/_includes/asides/category_feed.xml).
...
module Jekyll
  ...
  class CategoryFeed < CategoryPage
    ...
    #  +category+     is the category currently being processed.
    def initialize(site, base, category_dir, category)
      template_path = File.join(base, '_includes', 'aside', 'category_feed.xml')
